...
var resize_image_1 = __importDefault(require("../utils/resize_image"));
...
resizeRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        imageAvailable = utils_1.isImageAvailable(fileName + '.' + fileExtension);
        ...
        fullFileName = utils_1.getImageName(fileName, width, height, fileExtension);
        requestedSizeAvailable = utils_1.isImageAvailable(fullFileName);
        // If yes, send it
        ...
        resize_image_1.default(fileName, fileExtension, parseInt(width), parseInt(height), path_1.default.join(__dirname, '/../images'), path_1.default.join(__dirname, '/../images'))
